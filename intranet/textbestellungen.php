...
require_once __DIR__ . "/../wp-content/plugins/hoffmann-kundenportal/hoffmann-textbestellung.php";
hoffmann_handle_textbestellung_submission();
$form = hoffmann_render_textbestellung_form();
?>
<!DOCTYPE html>
<html lang="zxx">
...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Textbestellung</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
        ...
        <div class="header-wrapper">
            ...
            <div class="header-right ms-auto">
                <div class="d-flex align-items-center">
                    ...
                    </div>                            <div class="language-items-wrapper">
